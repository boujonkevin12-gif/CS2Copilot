...
export const SHOP_ITEMS: ShopItem[] = [
  { id: "frame_4", name: "Marco Nvl. 3", category: "frame", price: 200, levelReq: 3, rarity: "common", desc: "Marco rank 1" },
  { id: "frame_8", name: "Marco Nvl. 5", category: "frame", price: 350, levelReq: 5, rarity: "common", desc: "Marco rank 2" },
  { id: "frame_2", name: "Marco Nvl. 7", category: "frame", price: 400, levelReq: 7, rarity: "rare", desc: "Marco rank 3" },
  { id: "frame_3", name: "Marco Nvl. 7", category: "frame", price: 500, levelReq: 7, rarity: "rare", desc: "Marco rank 4" },
  { id: "frame_7", name: "Marco Nvl. 10", category: "frame", price: 700, levelReq: 10, rarity: "rare", desc: "Marco rank 5" },
  { id: "frame_5", name: "Marco Nvl. 15", category: "frame", price: 1200, levelReq: 15, rarity: "epic", desc: "Marco rank 6" },
  { id: "frame_1", name: "Marco Nvl. 20", category: "frame", price: 1800, levelReq: 20, rarity: "epic", desc: "Marco rank 7" },
  { id: "frame_9", name: "Marco Nvl. 25", category: "frame", price: 2500, levelReq: 25, rarity: "legendary", desc: "Marco rank 8" },
  { id: "frame_6", name: "Marco Nvl. 30", category: "frame", price: 3500, levelReq: 30, rarity: "legendary", desc: "Marco GIF rank 9" },

  { id: "bg_10", name: "Fondo Nvl. 1", category: "background", price: 100, levelReq: 1, rarity: "common", desc: "Fondo rank 1" },
  { id: "bg_11", name: "Fondo Nvl. 3", category: "background", price: 200, levelReq: 3, rarity: "common", desc: "Fondo rank 2" },
  { id: "bg_4", name: "Fondo Nvl. 5", category: "background", price: 350, levelReq: 5, rarity: "rare", desc: "Fondo rank 3" },
  { id: "bg_9", name: "Fondo Nvl. 7", category: "background", price: 500, levelReq: 7, rarity: "rare", desc: "Fondo rank 4" },
  { id: "bg_5", name: "Fondo Nvl. 10", category: "background", price: 700, levelReq: 10, rarity: "rare", desc: "Fondo rank 5" },
  { id: "bg_7", name: "Fondo Nvl. 12", category: "background", price: 900, levelReq: 12, rarity: "epic", desc: "Fondo rank 6" },
  { id: "bg_8", name: "Fondo Nvl. 15", category: "background", price: 1200, levelReq: 15, rarity: "epic", desc: "Fondo rank 7" },
  { id: "bg_3", name: "Fondo Nvl. 18", category: "background", price: 1500, levelReq: 18, rarity: "epic", desc: "Fondo rank 8" },
  { id: "bg_6", name: "Fondo Nvl. 20", category: "background", price: 1800, levelReq: 20, rarity: "legendary", desc: "Fondo rank 9" },
  { id: "bg_2", name: "Fondo Nvl. 25", category: "background", price: 2500, levelReq: 25, rarity: "legendary", desc: "Fondo rank 10" },
  { id: "bg_1", name: "Fondo Nvl. 30", category: "background", price: 3500, levelReq: 30, rarity: "legendary", desc: "Fondo rank 11" },
